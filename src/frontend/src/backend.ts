...
import type { Inquiry as _Inquiry, ProjectType as _ProjectType } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async submitInquiry(arg0: string, arg1: string, arg2: string, arg3: ProjectType, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitInquiry(arg0, arg1, arg2, to_candid_ProjectType_n6(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_variant_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "commercial" in value ? ProjectType.commercial : "other" in value ? ProjectType.other : "residential" in value ? ProjectType.residential : "industrial" in value ? ProjectType.industrial : value;
}
